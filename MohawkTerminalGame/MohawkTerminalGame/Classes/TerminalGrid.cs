...
public sealed class TerminalGrid
{
    ...
    public TerminalGrid(string defaultChar = " ") : this(Terminal.WindowWidth, Terminal.WindowHeight, defaultChar)
    {
    }
    public TerminalGrid(int widthInChars, int heightInChars, string defaultChar = " ")
    {
        Width = widthInChars;
    ...
    public void SetRectangle(string value, int x, int y, int w, int h)
    ...
    public static TerminalGrid CopyArea(TerminalGrid src, Rectangle area)
    {
        ...
        TerminalGrid copy = new(area.w, area.h);
    ...
    /// 
    /// </exception>
    public static void CopyFromTo(TerminalGrid src, Rectangle srcRect, TerminalGrid dest, int destX, int destY)
    {
        ...
        // Copy area of source
        TerminalGrid srcAreaCopy = CopyArea(src, srcRect);
